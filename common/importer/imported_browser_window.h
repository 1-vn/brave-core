...
#ifndef ONEVN_COMMON_IMPORTER_IMPORTED_BROWSER_WINDOW_H_
#define ONEVN_COMMON_IMPORTER_IMPORTED_BROWSER_WINDOW_H_
...
#endif  // ONEVN_COMMON_IMPORTER_IMPORTED_BROWSER_WINDOW_H_
