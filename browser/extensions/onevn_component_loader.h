...
#ifndef ONEVN_BROWSER_EXTENSIONS_ONEVN_COMPONENT_LOADER_H_
#define ONEVN_BROWSER_EXTENSIONS_ONEVN_COMPONENT_LOADER_H_
...
#endif  // ONEVN_BROWSER_EXTENSIONS_ONEVN_COMPONENT_LOADER_H_
