...
#ifndef ONEVN_BROWSER_UI_ONEVN_ACTIONS_ONEVN_ACTION_ICON_WITH_BADGE_IMAGE_SOURCE_H_
#define ONEVN_BROWSER_UI_ONEVN_ACTIONS_ONEVN_ACTION_ICON_WITH_BADGE_IMAGE_SOURCE_H_
