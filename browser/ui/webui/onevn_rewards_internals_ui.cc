...
#include "onevn/browser/ui/webui/onevn_rewards_internals_ui.h"
...
class RewardsInternalsDOMHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  void OnGetRewardsInternalsInfo(
      std::unique_ptr<onevn_rewards::RewardsInternalsInfo> info);
...
void RewardsInternalsDOMHandler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "onevn_rewards_internals.getRewardsEnabled",
      base::BindRepeating(&RewardsInternalsDOMHandler::HandleGetRewardsEnabled,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "onevn_rewards_internals.getRewardsInternalsInfo",
      base::BindRepeating(
...
void RewardsInternalsDOMHandler::HandleGetRewardsEnabled(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "onevn_rewards_internals.onGetRewardsEnabled",
...
void RewardsInternalsDOMHandler::OnGetRewardsInternalsInfo(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "onevn_rewards_internals.onGetRewardsInternalsInfo", info_dict);
}
