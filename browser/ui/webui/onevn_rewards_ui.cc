...
#include "onevn/browser/ui/webui/onevn_rewards_ui.h"
...
#include "onevn/components/onevn_rewards/resources/grit/onevn_rewards_generated_map.h"
#else
#include "components/onevn_rewards/settings/resources/grit/onevn_rewards_settings_generated_map.h"
...
class RewardsDOMHandler : public WebUIMessageHandler,
 ...
 private:
  ...
  void OnContentSiteList(
      std::unique_ptr<onevn_rewards::ContentSiteList>,
      uint32_t record);
  void OnGetAllBalanceReports(
      const std::map<std::string, onevn_rewards::BalanceReport>& reports);
  ...
  void OnGetAutoContributeProps(
      ...
      std::unique_ptr<onevn_rewards::AutoContributeProps> auto_contri_props);
  ...
  void OnContentSiteUpdated(
      onevn_rewards::RewardsService* rewards_service) override;
  ...
  void OnGrant(onevn_rewards::RewardsService* rewards_service,
                   unsigned int error_code,
                   onevn_rewards::Grant result) override;
  void OnGrantCaptcha(onevn_rewards::RewardsService* rewards_service,
  ...
  void OnGrantFinish(onevn_rewards::RewardsService* rewards_service,
                       unsigned int result,
                       onevn_rewards::Grant grant) override;
  void OnExcludedSitesChanged(onevn_rewards::RewardsService* rewards_service,
                              std::string publisher_id,
                              bool excluded) override;
  void OnReconcileComplete(onevn_rewards::RewardsService* rewards_service,
                           unsigned int result,
  ...
  void OnRecurringTipSaved(onevn_rewards::RewardsService* rewards_service,
                           bool success) override;

  void OnRecurringTipRemoved(onevn_rewards::RewardsService* rewards_service,
                             bool success) override;
  ...
  void OnNotificationAdded(
      onevn_rewards::RewardsNotificationService* rewards_notification_service,
      const onevn_rewards::RewardsNotificationService::RewardsNotification&
          notification) override;
  void OnNotificationDeleted(
      onevn_rewards::RewardsNotificationService* rewards_notification_service,
      const onevn_rewards::RewardsNotificationService::RewardsNotification&
          notification) override;
  void OnAllNotificationsDeleted(onevn_rewards::RewardsNotificationService*
  ...
  void OnGetAllNotifications(
      onevn_rewards::RewardsNotificationService* rewards_notification_service,
      const onevn_rewards::RewardsNotificationService::RewardsNotificationsList&
          notifications_list) override;

  onevn_rewards::RewardsService* rewards_service_;  // NOT OWNED
  onevn_ads::AdsService* ads_service_;
...
void RewardsDOMHandler::RegisterMessages() {
  web_ui()->RegisterMessageCallback("onevn_rewards.createWalletRequested",
      base::BindRepeating(&RewardsDOMHandler::HandleCreateWalletRequested,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getWalletProperties",
      base::BindRepeating(&RewardsDOMHandler::GetWalletProperties,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getGrants",
      base::BindRepeating(&RewardsDOMHandler::GetGrants,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getGrantCaptcha",
      base::BindRepeating(&RewardsDOMHandler::GetGrantCaptcha,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getWalletPassphrase",
      base::BindRepeating(&RewardsDOMHandler::GetWalletPassphrase,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.recoverWallet",
      base::BindRepeating(&RewardsDOMHandler::RecoverWallet,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.solveGrantCaptcha",
      base::BindRepeating(&RewardsDOMHandler::SolveGrantCaptcha,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getReconcileStamp",
      base::BindRepeating(&RewardsDOMHandler::GetReconcileStamp,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getAddresses",
      base::BindRepeating(&RewardsDOMHandler::GetAddresses,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.saveSetting",
      base::BindRepeating(&RewardsDOMHandler::SaveSetting,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getBalanceReports",
      base::BindRepeating(&RewardsDOMHandler::GetBalanceReports,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.excludePublisher",
      base::BindRepeating(&RewardsDOMHandler::ExcludePublisher,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.restorePublishers",
      base::BindRepeating(&RewardsDOMHandler::RestorePublishers,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.checkWalletExistence",
      base::BindRepeating(&RewardsDOMHandler::WalletExists,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getContributionAmount",
      base::BindRepeating(&RewardsDOMHandler::GetContributionAmount,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.removeRecurringTip",
      base::BindRepeating(&RewardsDOMHandler::RemoveRecurringTip,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "onevn_rewards.getRecurringTips",
      base::BindRepeating(&RewardsDOMHandler::GetRecurringTips,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getOneTimeTips",
      base::BindRepeating(&RewardsDOMHandler::GetOneTimeTips,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getContributionList",
      base::BindRepeating(&RewardsDOMHandler::GetContributionList,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.checkImported",
      base::BindRepeating(&RewardsDOMHandler::CheckImported,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getAdsData",
      base::BindRepeating(&RewardsDOMHandler::GetAdsData,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.saveAdsSetting",
      base::BindRepeating(&RewardsDOMHandler::SaveAdsSetting,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.setBackupCompleted",
      base::BindRepeating(&RewardsDOMHandler::SetBackupCompleted,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "onevn_rewards.getPendingContributionsTotal",
      base::BindRepeating(&RewardsDOMHandler::GetPendingContributionsTotal,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getAddressesForPaymentId",
      base::BindRepeating(&RewardsDOMHandler::GetAddressesForPaymentId,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "onevn_rewards.getTransactionHistoryForThisCycle",
      base::BindRepeating(&RewardsDOMHandler::GetTransactionHistoryForThisCycle,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getRewardsMainEnabled",
      base::BindRepeating(&RewardsDOMHandler::GetRewardsMainEnabled,
      base::Unretained(this)));
  web_ui()->RegisterMessageCallback("onevn_rewards.getExcludedPublishersNumber",
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    if (!reports.empty()) {
      for (auto const& report : reports) {
        const onevn_rewards::BalanceReport oldReport = report.second;
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.balanceReports",
        newReports);
  }
}
...
void RewardsDOMHandler::OnWalletInitialized(
  ...
  if (result == 12) {
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.walletCreated");
  } else if (result != 3 && result != 0) {
    // Report back all errors except when ledger_state is missing
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.walletCreateFailed");
  }
}
...
void RewardsDOMHandler::OnGetAutoContributeProps(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
      "onevn_rewards.initAutoContributeSettings", values);

    result.SetDictionary("wallet", std::move(walletInfo));

    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.walletProperties", result);
  }
}
...
void RewardsDOMHandler::OnGrant(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.grant", newGrant);
  }
}
...
void RewardsDOMHandler::OnGrantCaptcha(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.grantCaptcha", captcha);
  }
}
...
void RewardsDOMHandler::OnGetWalletPassphrase(const std::string& pass) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.walletPassphrase",
        base::Value(pass));
  }
}
...
void RewardsDOMHandler::OnRecoverWallet(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.recoverWalletData", recover);
  }
}
...
void RewardsDOMHandler::OnGrantFinish(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.grantFinish", finish);
    GetAllBalanceReports();
  }
}
...
void RewardsDOMHandler::OnGetReconcileStamp(uint64_t reconcile_stamp) {
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.reconcileStamp",
        base::Value(stamp));
  }
}
...
void RewardsDOMHandler::OnGetAddresses(
  ...
  if (web_ui()->CanCallJavascript() && (
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards." + func_name, data);
  }
}
...
void RewardsDOMHandler::OnAutoContributePropsReady(
    std::unique_ptr<onevn_rewards::AutoContributeProps> props) {
...
void RewardsDOMHandler::OnGetExcludedPublishersNumber(uint32_t num) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.excludedNumber",
...
void RewardsDOMHandler::OnContentSiteList(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.contributeList", *publishers);
  }
}
...
void RewardsDOMHandler::OnIsWalletCreated(bool created) {
  if (web_ui()->CanCallJavascript())
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.walletExists",
        base::Value(created));
}
...
void RewardsDOMHandler::OnGetContributionAmount(double amount) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.contributionAmount",
        base::Value(amount));
  }
}
...
void RewardsDOMHandler::OnGetRecurringTips(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.recurringTips",
                                           *publishers);
  }
}
...
void RewardsDOMHandler::OnGetOneTimeTips(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.currentTips",
                                           *publishers);
  }
}
...
void RewardsDOMHandler::CheckImported(const base::ListValue *args) {
  if (web_ui()->CanCallJavascript() && rewards_service_) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.imported", base::Value(imported));
  }
}
...
void RewardsDOMHandler::GetAdsData(const base::ListValue *args) {
  ...
  web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.adsData", ads_data);
}
...
void RewardsDOMHandler::OnGetPendingContributionsTotal(double amount) {
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.pendingContributionTotal", base::Value(amount));
  }
}
...
void RewardsDOMHandler::OnPendingContributionSaved(
    ...
    if (web_ui()->CanCallJavascript()) {
      web_ui()->CallJavascriptFunctionUnsafe(
          "onevn_rewards.onPendingContributionSaved", base::Value(result));
    }
}
...
void RewardsDOMHandler::OnRewardsMainEnabled(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe("onevn_rewards.rewardsEnabled",
...
void RewardsDOMHandler::OnPublisherListNormalized(
  ...
  OnContentSiteList(std::make_unique<onevn_rewards::ContentSiteList>(list), 0);
}
...
void RewardsDOMHandler::OnTransactionHistoryForThisCycle(
  ...
  if (web_ui()->CanCallJavascript()) {
    ...
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.transactionHistoryForThisCycle", history);
  }
}
...
void RewardsDOMHandler::OnTransactionHistoryForThisCycleChanged(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.transactionHistoryForThisCycleChanged");
  }
}
...
void RewardsDOMHandler::OnRecurringTipSaved(
  ...
  if (web_ui()->CanCallJavascript()) {
    web_ui()->CallJavascriptFunctionUnsafe(
        "onevn_rewards.recurringTipSaved", base::Value(success));
  }
}
...
void RewardsDOMHandler::OnRecurringTipRemoved(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "onevn_rewards.recurringTipRemoved", base::Value(success));
}
...
void RewardsDOMHandler::OnContributionSaved(
  ...
  web_ui()->CallJavascriptFunctionUnsafe(
      "onevn_rewards.onContributionSaved", result);
}
