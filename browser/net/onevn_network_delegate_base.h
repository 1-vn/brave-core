...
#ifndef ONEVN_BROWSER_NET_ONEVN_NETWORK_DELEGATE_BASE_H_
#define ONEVN_BROWSER_NET_ONEVN_NETWORK_DELEGATE_BASE_H_
...
class OneVNNetworkDelegateBase : public ChromeNetworkDelegate {
 ...
 protected:
  ...
  std::vector<onevn::OnHeadersReceivedCallback> headers_received_callbacks_;
  std::vector<onevn::OnCanGetCookiesCallback> can_get_cookies_callbacks_;
  std::vector<onevn::OnCanSetCookiesCallback> can_set_cookies_callbacks_;
