...
#define HasAPIKeyConfigured OneVNHasAPIKeyConfigured
#include "../../../../../../components/translate/core/browser/translate_manager.cc" // NOLINT
#undef HasAPIKeyConfigured

namespace google_apis {

bool OneVNHasAPIKeyConfigured() {
  // Google API key is not used in onevn for translation service, always return
