...
#ifndef ONEVN_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
#define ONEVN_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
...
#endif  // ONEVN_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
