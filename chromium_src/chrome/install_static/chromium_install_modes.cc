...
// Brand-specific constants and install modes for Onevn.
...
const wchar_t kCompanyPathName[] = L"OnevnSoftware";

#if defined(OFFICIAL_BUILD)
const wchar_t kProductPathName[] = L"Onevn-Browser";
#else
const wchar_t kProductPathName[] = L"Onevn-Browser-Development";
#endif
...
#if defined(OFFICIAL_BUILD)
// Onevn integrates with Onevn Update, so the app GUID above is used.
const wchar_t kBinariesPathName[] = L"";
#else
const wchar_t kBinariesPathName[] = L"Onevn Binaries";
#endif
...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable Onevn.
    {
        ...
        L"Onevn",                           // A distinct base_app_name.
        L"Onevn",                           // A distinct base_app_id.
        L"OnevnHTML",                              // ProgID prefix.
        L"Onevn HTML Document",                    // ProgID description.
    ...
    // A secondary install mode for Onevn Beta
    {
        sizeof(kInstallModes[0]),
        ...
        L"Onevn Beta",                      // A distinct base_app_name.
        L"OnevnBeta",                              // A distinct base_app_id.
        L"OnevnBHTML",                             // ProgID prefix.
        L"Onevn Beta HTML Document",               // ProgID description.
    ...
    // A secondary install mode for Onevn Dev
    {
        sizeof(kInstallModes[0]),
        ...
        L"Onevn Dev",                       // A distinct base_app_name.
        L"OnevnDev",                               // A distinct base_app_id.
        L"OnevnDHTML",                             // ProgID prefix.
        L"Onevn Dev HTML Document",                // ProgID description.
    ...
    // A secondary install mode for Onevn SxS (canary).
    {
        sizeof(kInstallModes[0]),
        ...
        L"Onevn Nightly",                    // A distinct base_app_name.
        L"OnevnNightly",                            // A distinct base_app_id.
        L"OnevnSSHTM",                             // ProgID prefix.
        L"Onevn Nightly HTML Document",             // ProgID description.
...
#else
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Onevn developer build.
    {
        sizeof(kInstallModes[0]),
        ...
        L"",              // Empty install_suffix for the primary install mode.
        L"",              // No logo suffix for the primary install mode.
        L"",            // Empty app_guid since no integraion with Onevn Update.
        L"Onevn Development",  // A distinct base_app_name.
        L"OnevnDevelopment",   // A distinct base_app_id.
        L"OnevnDevHTM",                             // ProgID prefix.
        L"Onevn Development HTML Document",           // ProgID description.
