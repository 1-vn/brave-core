  ...
  public:
    ...
    void BlockReferrers() {
      content_settings()->SetContentSettingCustomScope(top_level_page_pattern(),
          ...
          onevn_shields::kReferrers, CONTENT_SETTING_BLOCK);
      ContentSettingsForOneType settings;
      content_settings()->GetSettingsForOneType(
          CONTENT_SETTINGS_TYPE_PLUGINS, onevn_shields::kReferrers, &settings);
    ...
    void Block3PCookies() {
      content_settings()->SetContentSettingCustomScope(
          ...
          onevn_shields::kCookies, CONTENT_SETTING_BLOCK);
      content_settings()->SetContentSettingCustomScope(
          top_level_page_pattern(),
          first_party_pattern(),
          CONTENT_SETTINGS_TYPE_PLUGINS,
          onevn_shields::kCookies, CONTENT_SETTING_ALLOW);
    }
...
IN_PROC_BROWSER_TEST_F(OnevnContentSettingsObserverBrowserTest,
  ...
  content_settings()->GetSettingsForOneType(
      CONTENT_SETTINGS_TYPE_PLUGINS, onevn_shields::kFingerprinting,
      &fp_settings);
