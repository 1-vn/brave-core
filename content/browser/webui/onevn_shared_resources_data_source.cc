...
#include "onevn/content/browser/webui/onevn_shared_resources_data_source.h"
...
#include "onevn/ui/webui/resources/grit/onevn_webui_resources.h"
#include "onevn/ui/webui/resources/grit/onevn_webui_resources_map.h"
...
const std::map<std::string, std::string> CreatePathPrefixAliasesMap() {
  ...
  // onevn://onevn-resources/blah/X could be mapped to
