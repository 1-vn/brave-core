...
public:
  ...
  void PreRunTestOnMainThread() override {
    ...
    ASSERT_TRUE(
      g_onevn_browser_process->https_everywhere_service()->IsInitialized());
  }
  ...
  void InitService() {
    onevn_shields::HTTPSEverywhereService::SetIgnorePortForTest(true);
  ...
  bool InstallHTTPSEverywhereExtension() {
    ...
    g_onevn_browser_process->https_everywhere_service()->OnComponentReady(
  ...
  void WaitForHTTPSEverywhereServiceThread() {
    scoped_refptr<base::ThreadTestHelper> io_helper(
        new base::ThreadTestHelper(
            g_onevn_browser_process->https_everywhere_service()->GetTaskRunner()));
