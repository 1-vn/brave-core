...
class ReferrerWhitelistServiceTest : public ExtensionBrowserTest {
 public:
  ...
  void PreRunTestOnMainThread() override {
    ...
    ASSERT_TRUE(g_onevn_browser_process->local_data_files_service()->
                IsInitialized());
  }
  ...
  bool InstallReferrerWhitelistExtension() {
    ...
    g_onevn_browser_process->referrer_whitelist_service()->OnComponentReady(
  ...
  bool IsWhitelistedReferrer(
    ...
    return g_onevn_browser_process->referrer_whitelist_service()->
