...
#ifndef ONEVN_COMPONENTS_ONEVN_SHIELDS_BROWSER_TRACKING_PROTECTION_SERVICE_H_
#define ONEVN_COMPONENTS_ONEVN_SHIELDS_BROWSER_TRACKING_PROTECTION_SERVICE_H_
...
// The onevn shields service in charge of tracking protection and init.
class TrackingProtectionService : public BaseLocalDataFilesObserver {
 ...
 private:
  ...
  onevn_shields::DATFileDataBuffer storage_trackers_buffer_;
#endif
...
#endif  // ONEVN_COMPONENTS_ONEVN_SHIELDS_BROWSER_TRACKING_PROTECTION_SERVICE_H_
