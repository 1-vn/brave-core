...
#ifndef ONEVN_COMPONENTS_ONEVN_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
#define ONEVN_COMPONENTS_ONEVN_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
...
#endif  // ONEVN_COMPONENTS_ONEVN_SHIELDS_BROWSER_AD_BLOCK_SERVICE_H_
