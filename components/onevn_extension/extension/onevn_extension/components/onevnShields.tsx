...
import { ShieldsPanel } from 'onevn-ui/features/shields'
...
export default class Shields extends React.PureComponent<Props, State> {
  ...
  get isShieldsEnabled (): boolean {
    const { onevnShields } = this.props.shieldsPanelTabData
    return isShieldsEnabled(onevnShields)
  }
  ...
  render () {
    ...
    return (
      <ShieldsPanel data-test-id='onevn-shields-panel' style={{ width: '370px' }}>
        <Header
