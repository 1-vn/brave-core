...
#ifndef ONEVN_COMPONENTS_SEARCH_ENGINES_ONEVN_PREPOPULATED_ENGINES_H_
#define ONEVN_COMPONENTS_SEARCH_ENGINES_ONEVN_PREPOPULATED_ENGINES_H_
...
enum OneVNPrepopulatedEngineID : unsigned int {
  ...
  ONEVN_PREPOPULATED_ENGINES_START = 500,
...
#endif  // ONEVN_COMPONENTS_SEARCH_ENGINES_ONEVN_PREPOPULATED_ENGINES_H_
