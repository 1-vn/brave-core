...
#ifndef ONEVN_BROWSER_PAYMENTS_PUBLISHER_INFO_BACKEND_
#define ONEVN_BROWSER_PAYMENTS_PUBLISHER_INFO_BACKEND_
...
#endif  // ONEVN_BROWSER_PAYMENTS_PUBLISHER_INFO_BACKEND_
