...
#ifndef ONEVN_COMPONENTS_ONEVN_REWARDS_BROWSER_REWARDS_SERVICE_IMPL_H_
#define ONEVN_COMPONENTS_ONEVN_REWARDS_BROWSER_REWARDS_SERVICE_IMPL_H_
...
class RewardsServiceImpl : public RewardsService,
 ...
 private:
  ...
  void OnDonate(const std::string& publisher_key, int amount, bool recurring,
      std::unique_ptr<onevn_rewards::ContentSite> site) override;
...
#endif  // ONEVN_COMPONENTS_ONEVN_REWARDS_BROWSER_REWARDS_SERVICE_IMPL_H_
