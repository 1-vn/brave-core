...
#ifndef ONEVN_COMPONENTS_ONEVN_REWARDS_BROWSER_PUBLISHER_INFO_DATABASE_H_
#define ONEVN_COMPONENTS_ONEVN_REWARDS_BROWSER_PUBLISHER_INFO_DATABASE_H_
...
#include "onevn/components/onevn_rewards/browser/contribution_info.h"
...
class PublisherInfoDatabase {
 public:
  ...
  bool InsertContributionInfo(const onevn_rewards::ContributionInfo& info);
...
#endif  // ONEVN_COMPONENTS_ONEVN_REWARDS_BROWSER_PUBLISHER_INFO_DATABASE_H_
