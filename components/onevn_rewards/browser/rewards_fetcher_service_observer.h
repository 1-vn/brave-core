...
#ifndef ONEVN_COMPONENTS_ONEVN_REWARDS_REWARDS_FETCHER_SERVICE_OBSERVER_H_
#define ONEVN_COMPONENTS_ONEVN_REWARDS_REWARDS_FETCHER_SERVICE_OBSERVER_H_
...
#endif  // ONEVN_COMPONENTS_ONEVN_REWARDS_REWARDS_FETCHER_SERVICE_OBSERVER_H_
