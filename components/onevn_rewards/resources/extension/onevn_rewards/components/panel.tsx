...
import { WalletAddIcon, BatColorIcon } from 'onevn-ui/components/icons'
import { WalletWrapper, WalletSummary, WalletSummarySlider, WalletPanel } from 'onevn-ui/features/rewards'
import { Provider } from 'onevn-ui/features/rewards/profile'
import { NotificationType } from 'onevn-ui/features/rewards/walletWrapper'
import { RewardsNotificationType } from '../constants/rewards_panel_types'
import { Type as AlertType } from 'onevn-ui/features/rewards/alert'
...
export class Panel extends React.Component<Props, State> {
  ...
  showDonateToSiteDetail = () => {
    ...
    chrome.tabs.query({
      ...
      chrome.onevnRewards.donateToSite(tabId, publisher.publisher_key)
      window.close()
    })
  }
  ...
  getNotification = () => {
    ...
    switch (notification.type) {
      ...
      case RewardsNotificationType.REWARDS_NOTIFICATION_ADS_LAUNCH:
        type = 'ads-launch'
        text = getMessage('onevnAdsLaunchMsg')
        break
      default:
        type = ''
        break
  ...
  refreshPublisher = () => {
    ...
    const publisherKey = publisher && publisher.publisher_key
    if (publisherKey) {
      chrome.onevnRewards.refreshPublisher(publisherKey, (verified: boolean, publisherKey: string) => {
        if (publisherKey) {
        ...
        >
          {
            ...
            ? <WalletPanel
              ...
              moreLink={'https://1-vn.com/faq-rewards/#unclaimed-funds'}
          ...
          <WalletSummary
            ...
            reservedMoreLink={'https://1-vn.com/faq-rewards/#unclaimed-funds'}
