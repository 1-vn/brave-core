...
import {
  ...
  WalletEmpty,
  WalletSummary
} from 'onevn-ui/features/rewards'
import { WalletAddIcon } from 'onevn-ui/components/icons'
import { AlertWallet } from 'onevn-ui/features/rewards/walletWrapper'

// Utils
import { getLocale } from '../../../../common/locale'
import * as rewardsActions from '../actions/rewards_actions'
import * as utils from '../utils'
import WalletOff from 'onevn-ui/features/rewards/walletOff'
import ModalAddFunds from 'onevn-ui/features/rewards/modalAddFunds'
...
class PageWallet extends React.Component<Props, State> {
  ...
  onModalBackupOnCopy = async (backupKey: string) => {
    ...
    try {
      ...
      chrome.send('onevn_rewards.setBackupCompleted')
    } catch (e) {
  ...
  onModalBackupOnSaveFile = (backupKey: string) => {
    ...
    const backupFileText = 'onevn_wallet_recovery.txt'
