...
// Components
import { Column, Grid } from 'onevn-ui/components'
import { DisabledBox, MainToggle, SettingsPage as Page } from 'onevn-ui/features/rewards'
...
class SettingsPage extends React.Component<Props, {}> {
  ...
  componentDidMount () {
    ...
    // more info here https://github.com/1-vn/onevn-browser/issues/2172
    ...
    if (!this.props.rewardsData.ui.paymentIdCheck) {
      // https://github.com/1-vn/onevn-browser/issues/3060
      this.actions.getAddressesForPaymentId()
      // https://github.com/1-vn/onevn-browser/issues/3061
      this.actions.getWalletPassphrase()
    }
  }
  ...
  openTOS () {
    window.open('https://1-vn.com/terms-of-use', '_blank')
  }

  openPrivacyPolicy () {
    window.open('https://1-vn.com/privacy#rewards', '_blank')
  }
