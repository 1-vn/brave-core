...
import { initLocale } from 'onevn-ui'
...
window.cr.define('onevn_rewards_donate', function () {
  'use strict'
  ...
  function initialize () {
    ...
    try {
      ...
      chrome.send('onevn_rewards_donate.getPublisherBanner', [args.publisherKey])
...
document.addEventListener('DOMContentLoaded', window.onevn_rewards_donate.initialize)
