...
#ifndef ONEVN_COMPONENTS_SERVICES_BAT_LEDGER_BAT_LEDGER_IMPL_H_
#define ONEVN_COMPONENTS_SERVICES_BAT_LEDGER_BAT_LEDGER_IMPL_H_
...
#endif  // ONEVN_COMPONENTS_SERVICES_BAT_LEDGER_BAT_LEDGER_IMPL_H_
