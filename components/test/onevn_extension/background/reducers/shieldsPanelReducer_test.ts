...
import * as types from '../../../../onevn_extension/extension/onevn_extension/constants/shieldsPanelTypes'
...
import * as browserActionAPI from '../../../../onevn_extension/extension/onevn_extension/background/api/browserActionAPI'
...
describe('onevnShieldsPanelReducer', () => {
    ...
    it('increments for JS blocking', () => {
      let nextState = shieldsPanelReducer(state, {
        ...
        details: {
          blockType: 'javascript',
          tabId: 2,
          subresource: 'https://test.1-vn.com/index.js'
        }
      })
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            cookies: 'block',
            noScriptInfo: {
              'https://test.1-vn.com/': { actuallyBlocked: true, willBlock: true }
            },
            trackersBlockedResources: [],
            adsBlockedResources: [],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: [ 'https://test.1-vn.com/index.js' ]
          }
        },
        windows: {
          1: 2
    ...
    it('increments for fingerprinting blocked', () => {
      let nextState = shieldsPanelReducer(state, {
        ...
        details: {
          ...
          tabId: 2,
          subresource: 'https://test.1-vn.com'
        }
      })
      expect(nextState).toEqual({
        currentWindowId: 1,
        tabs: {
          2: {
            ...
            trackersBlockedResources: [],
            adsBlockedResources: [],
            fingerprintingBlockedResources: [ 'https://test.1-vn.com' ],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
          }
        },
    ...
    it('increases same count consecutively', () => {
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            noScriptInfo: {},
            trackersBlockedResources: [],
            adsBlockedResources: [ 'https://test.1-vn.com' ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
          }
      ...
      nextState = shieldsPanelReducer(nextState, {
        ...
        details: {
          blockType: 'ads',
          tabId: 2,
          subresource: 'https://test2.1-vn.com'
        }
      })
      expect(nextState).toEqual({
        currentWindowId: 1,
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            cookies: 'block',
            noScriptInfo: {},
            trackersBlockedResources: [ 'https://test.1-vn.com' ],
            adsBlockedResources: [ 'https://test.1-vn.com' ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [],
            javascriptBlockedResources: []
      ...
      expect(nextState).toEqual({
        ...
        tabs: {
          2: {
            ...
            adsBlockedResources: [ 'https://test.1-vn.com' ],
            fingerprintingBlockedResources: [],
            httpsRedirectedResources: [ 'https://test.1-vn.com' ],
            javascriptBlockedResources: []
          }
        },
        windows: {
