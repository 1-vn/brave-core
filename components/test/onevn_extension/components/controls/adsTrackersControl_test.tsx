...
import AdsTrackersControl, { Props } from '../../../../onevn_extension/extension/onevn_extension/components/controls/adsTrackersControl'
...
describe('AdsTrackersControl component', () => {
