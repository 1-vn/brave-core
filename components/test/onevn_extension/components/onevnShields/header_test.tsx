...
import ShieldsHeader, { Props } from '../../../../onevn_extension/extension/onevn_extension/components/header'
import { BlockOptions } from '../../../../onevn_extension/extension/onevn_extension/types/other/blockTypes'
...
describe('ShieldsHeader component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#onevnShieldsHeader').length === 1
