...
import ShieldsFooter, { Props } from '../../../../onevn_extension/extension/onevn_extension/components/footer'
...
describe('ShieldsFooter component', () => {
  ...
  it('renders the component', () => {
    ...
    const assertion = wrapper.find('#onevnShieldsFooter').length === 1
  ...
  describe('when edit default settings is clicked', () => {
    ...
    it('calls chrome.tab.create', () => {
      ...
      const wrapper = shallow(baseComponent())
      wrapper.find('#onevnShieldsFooter').simulate('click', value)
