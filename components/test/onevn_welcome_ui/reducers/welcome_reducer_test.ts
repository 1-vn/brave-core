...
import welcomeReducer from '../../../onevn_welcome_ui/reducers/welcome_reducer'
import * as actions from '../../../onevn_welcome_ui/actions/welcome_actions'
import { types } from '../../../onevn_welcome_ui/constants/welcome_types'
  ...
  describe('GO_TO_TAB_REQUESTED', () => {
    it('calls window.open', () => {
      welcomeReducer(undefined, {
        ...
        payload: { url: 'https://1-vn.com', target: '_blank' }
      })
