...
import { types } from '../../../onevn_webtorrent/extension/constants/webtorrent_types'
import * as actions from '../../../onevn_webtorrent/extension/actions/webtorrent_actions'
...
const torrent: Torrent = {
  ...
  torrentFileBlobURL: 'https://1-vn.com',
  files: [],
  received: 1337,
  path: '/',
  ready: true,
