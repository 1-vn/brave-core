...
import { webtorrentReducer } from '../../../../onevn_webtorrent/extension/background/reducers/webtorrent_reducer'
import * as tabActions from '../../../../onevn_webtorrent/extension/actions/tab_actions'
import * as windowActions from '../../../../onevn_webtorrent/extension/actions/window_actions'
import { torrentsState } from '../../testData'

// this import seems to trigger createStore and get an undefined reducer
jest.mock('../../../../onevn_webtorrent/extension/background/events/torrentEvents')
