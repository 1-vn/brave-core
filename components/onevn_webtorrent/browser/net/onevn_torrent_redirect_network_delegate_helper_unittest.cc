...
#include "onevn/browser/tor/mock_tor_profile_service_factory.h"
 ...
 public:
  ...
  void SetUp() override {
    ...
    extension_url_ = GURL(
        ...
        "onevn_webtorrent.html?https://webtorrent.io/torrents/sintel.torrent");
    non_torrent_extension_url_ = GURL(
        "chrome-extension://lgjmpdmojkpocjcopdikifhejkkjglho/extension/"
        "onevn_webtorrent.html?https://webtorrent.io/torrents/sintel");
  }
...
TEST_F(OnevnTorrentRedirectNetworkDelegateHelperTest,
  ...
  int ret = webtorrent::OnHeadersReceived_TorrentRedirectWork(request.get(),
      ...
      &allowed_unsafe_redirect_url, callback, onevn_request_info);
