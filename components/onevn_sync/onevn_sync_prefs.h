...
#ifndef ONEVN_COMPONENTS_ONEVN_SYNC_ONEVN_SYNC_PREFS_H_
#define ONEVN_COMPONENTS_ONEVN_SYNC_ONEVN_SYNC_PREFS_H_
...
class Prefs {
 public:
  ...
  std::unique_ptr<Settings> GetOneVNSyncSettings() const;
...
#endif  // ONEVN_COMPONENTS_ONEVN_SYNC_ONEVN_SYNC_PREFS_H_
