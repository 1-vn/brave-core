...
const char kSyncDeviceId[] = "onevn_sync.device_id";
const char kSyncSeed[] = "onevn_sync.seed";
const char kSyncPrevSeed[] = "onevn_sync.previous_seed";
const char kSyncDeviceName[] = "onevn_sync.device_name";
const char kSyncBookmarksBaseOrder[] = "onevn_sync.bookmarks_base_order";
const char kSyncEnabled[] = "onevn_sync.enabled";
const char kSyncBookmarksEnabled[] = "onevn_sync.bookmarks_enabled";
const char kSyncSiteSettingsEnabled[] = "onevn_sync.site_settings_enabled";
const char kSyncHistoryEnabled[] = "onevn_sync.history_enabled";
const char kSyncLatestRecordTime[] = "onevn_sync.latest_record_time";
const char kSyncLastFetchTime[] = "onevn_sync.last_fetch_time";
const char kSyncDeviceList[] = "onevn_sync.device_list";
const char kSyncApiVersion[] = "onevn_sync.api_version";
const char kSyncMigrateBookmarksVersion[]
                                       = "onevn_sync.migrate_bookmarks_version";
