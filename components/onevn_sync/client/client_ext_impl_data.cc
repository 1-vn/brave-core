...
#include "onevn/components/onevn_sync/client/client_data.h"
...
std::unique_ptr<onevn_sync::jslib::Site> FromExtSite(
    const extensions::api::onevn_sync::Site &ext_site) {
  auto site = std::make_unique<onevn_sync::jslib::Site>();
...
std::unique_ptr<onevn_sync::jslib::Device> FromExtDevice(
    const extensions::api::onevn_sync::Device &ext_device) {
  auto device = std::make_unique<onevn_sync::jslib::Device>();
  device->name = ext_device.name;
  return device;
}

std::unique_ptr<onevn_sync::jslib::SiteSetting> FromExtSiteSetting(
    const extensions::api::onevn_sync::SiteSetting &ext_site_setting) {
  auto site_setting = std::make_unique<onevn_sync::jslib::SiteSetting>();
...
std::unique_ptr<jslib::Bookmark> FromExtBookmark(
    const extensions::api::onevn_sync::Bookmark &ext_bookmark) {
...
std::unique_ptr<extensions::api::onevn_sync::Site> FromLibSite(
    const jslib::Site &lib_site) {
  auto ext_site = std::make_unique<extensions::api::onevn_sync::Site>();
...
std::unique_ptr<extensions::api::onevn_sync::Bookmark> FromLibBookmark(
    const jslib::Bookmark &lib_bookmark) {
  auto ext_bookmark = std::make_unique<extensions::api::onevn_sync::Bookmark>();
...
std::unique_ptr<extensions::api::onevn_sync::SiteSetting> FromLibSiteSetting(
    const jslib::SiteSetting &lib_site_setting) {
  auto ext_site_setting =
      std::make_unique<extensions::api::onevn_sync::SiteSetting>();
...
std::unique_ptr<extensions::api::onevn_sync::Device> FromLibDevice(
    const jslib::Device &lib_device) {
  auto ext_device = std::make_unique<extensions::api::onevn_sync::Device>();
  ext_device->name = lib_device.name;
  return ext_device;
}

std::unique_ptr<extensions::api::onevn_sync::SyncRecord> FromLibSyncRecord(
    const onevn_sync::SyncRecordPtr &lib_record) {
  DCHECK(lib_record);
  std::unique_ptr<extensions::api::onevn_sync::SyncRecord> ext_record =
      std::make_unique<extensions::api::onevn_sync::SyncRecord>();
...
onevn_sync::SyncRecordPtr FromExtSyncRecord(
    const extensions::api::onevn_sync::SyncRecord &ext_record) {
  onevn_sync::SyncRecordPtr record = std::make_unique<onevn_sync::jslib::SyncRecord>();

  record->action = ConvertEnum<onevn_sync::jslib::SyncRecord::Action>(ext_record.action,
...
void ConvertSyncRecords(
    const std::vector<extensions::api::onevn_sync::SyncRecord>& ext_records,
  std::vector<onevn_sync::SyncRecordPtr> &records) {
  DCHECK(records.empty());

  for (const extensions::api::onevn_sync::SyncRecord &ext_record : ext_records) {
    onevn_sync::SyncRecordPtr record = FromExtSyncRecord(ext_record);
...
void ConvertResolvedPairs(
  ...
  for (const SyncRecordAndExistingPtr &src : records_and_existing_objects) {
    ...
    std::unique_ptr<extensions::api::onevn_sync::RecordAndExistingObject> dest =
      std::make_unique<extensions::api::onevn_sync::RecordAndExistingObject>();
...
void ConvertSyncRecordsFromLibToExt(
    const std::vector<onevn_sync::SyncRecordPtr>& records,
    std::vector<extensions::api::onevn_sync::SyncRecord>& records_extension) {
  DCHECK(records_extension.empty());

  for (const onevn_sync::SyncRecordPtr &src : records) {
    std::unique_ptr<extensions::api::onevn_sync::SyncRecord> dest =
