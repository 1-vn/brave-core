...
std::unique_ptr<Value> OnevnSyncSettingsToValue(onevn_sync::Settings *onevn_sync_settings) {
  ...
  result->SetKey("this_device_name", Value(onevn_sync_settings->this_device_name_));
  result->SetKey("this_device_id", Value(onevn_sync_settings->this_device_id_));
  result->SetKey("sync_this_device", Value(onevn_sync_settings->sync_this_device_));
  result->SetKey("sync_bookmarks", Value(onevn_sync_settings->sync_bookmarks_));
  result->SetKey("sync_settings", Value(onevn_sync_settings->sync_settings_));
  result->SetKey("sync_history", Value(onevn_sync_settings->sync_history_));

  result->SetKey("sync_configured", Value(onevn_sync_settings->sync_configured_));
