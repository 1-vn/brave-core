...
// Images
import { WelcomeRewardsImage } from 'onevn-ui/features/welcome/images'
...
export default class PaymentsBox extends React.PureComponent<Props, {}> {
  render () {
    ...
    return (
      ...
      >
        <WelcomeRewardsImage />
        <Title>{getLocale('enableOnevnRewards')}</Title>
        <Paragraph>{getLocale('setupOnevnRewards')}</Paragraph>
        <Button
          level='primary'
          type='accent'
          size='large'
