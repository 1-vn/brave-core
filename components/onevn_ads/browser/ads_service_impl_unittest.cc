...
#include "onevn/components/onevn_ads/browser/test_util.h"
...
// npm run test -- onevn_unit_tests --filter=AdsServiceTest.*
 ...
 public:
  ...
  MOCK_METHOD7(GetContentSiteList,
      void(uint32_t,
           ...
           bool,
           uint32_t,
           const onevn_rewards::GetContentSiteListCallback&));
  ...
  MOCK_METHOD1(GetWalletPassphrase,
      void(const onevn_rewards::GetWalletPassphraseCallback&));
  MOCK_METHOD1(GetExcludedPublishersNumber,
      void(const onevn_rewards::GetExcludedPublishersNumberCallback&));
  ...
  MOCK_METHOD1(GetAutoContribute,
      void(onevn_rewards::GetAutoContributeCallback));
  ...
  MOCK_METHOD1(GetAllBalanceReports,
      void(const onevn_rewards::GetAllBalanceReportsCallback&));
  MOCK_METHOD0(GetCurrentBalanceReport, void());
  MOCK_METHOD1(IsWalletCreated,
      void(const onevn_rewards::IsWalletCreatedCallback&));
  MOCK_METHOD4(GetPublisherActivityFromUrl, void(uint64_t,
                                                 const std::string&,
                                                 const std::string&,
                                                 const std::string&));
  MOCK_METHOD1(GetContributionAmount,
      void(const onevn_rewards::GetContributionAmountCallback&));
  MOCK_METHOD2(GetPublisherBanner,
      void(const std::string&,
           onevn_rewards::GetPublisherBannerCallback));
