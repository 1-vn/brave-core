...
#ifndef ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_H_
#define ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_H_
...
#endif  // ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_H_
