...
#ifndef ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_IMPL_H_
#define ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_IMPL_H_
...
#endif  // ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_IMPL_H_
