...
#include "onevn/components/onevn_ads/browser/ad_notification.h"
#include "onevn/components/onevn_ads/browser/locale_helper.h"
#include "onevn/components/onevn_ads/browser/bundle_state_database.h"
#include "onevn/components/onevn_ads/common/pref_names.h"
#include "onevn/components/onevn_rewards/common/pref_names.h"
#include "onevn/components/onevn_ads/common/switches.h"
...
#include "onevn/components/services/bat_ads/public/cpp/ads_client_mojo_bridge.h"
...
AdsServiceImpl::AdsServiceImpl(Profile* profile)
  ...
  display_service_impl->AddNotificationHandler(
      NotificationHandler::Type::ONEVN_ADS,
...
void AdsServiceImpl::Shutdown() {
  ...
  for (NotificationInfoMap::iterator it = notification_ids_.begin();
    ...
    display_service_->Close(NotificationHandler::Type::ONEVN_ADS,
                            notification_id);
  }
...
void AdsServiceImpl::ShowNotification(
  ...
  display_service_->Display(NotificationHandler::Type::ONEVN_ADS,
                            *notification);
