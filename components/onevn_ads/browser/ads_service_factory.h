...
#ifndef ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_FACTORY_H_
#define ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_FACTORY_H_
...
class AdsServiceFactory : public BrowserContextKeyedServiceFactory {
 public:
  static onevn_ads::AdsService* GetForProfile(Profile* profile);
...
#endif  // ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_ADS_SERVICE_FACTORY_H_
