...
#include "onevn/components/onevn_ads/browser/background_helper_mac.h"
...
@interface BackgroundHelperDelegate : NSObject {
 @private
  onevn_ads::BackgroundHelper* helper_;  // NOT OWNED
}
...
- (id)initWithHelper:(onevn_ads::BackgroundHelper*)helper {
  if ((self = [super init])) {
    helper_ = helper;
