...
#ifndef ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_BUNDLE_STATE_DATABASE_H_
#define ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_BUNDLE_STATE_DATABASE_H_
...
#endif  // ONEVN_COMPONENTS_ONEVN_ADS_BROWSER_BUNDLE_STATE_DATABASE_H_
