...
import {
  ...
  FakeButton,
  Link
} from 'onevn-ui/features/newTab/private'

// Components
import { Toggle } from 'onevn-ui/features/shields'
      ...
      <Grid>
        <HeaderBox>
          <HeaderGrid>
            ...
            <div>
              ...
              <Text>{getLocale('headerText')} <Link href='https://support.1-vn.com/hc/en-us/articles/360017840332' target='_blank'>{getLocale('headerButton')}</Link>
              </Text>
            </div>
          </HeaderGrid>
        </HeaderBox>
        <Box style={{ minHeight: '475px' }}>
          ...
          <ButtonGroup>
            ...
            <Link href='https://support.1-vn.com/hc/en-us/articles/360018266171' target='_blank'>{getLocale('learnMore')}</Link>
          </ButtonGroup>
        </Box>
        <Box>
          <TorContent />
          <Separator />
          <FakeButton href='https://support.1-vn.com/hc/en-us/articles/360018121491' target='_blank'>
