...
OneVNShieldsContentSetting::OneVNShieldsContentSetting(APIRequestHandler* request_handler,
  ...
  }
  {
    ...
    resource_identifier_spec->set_ref("onevnShields.ResourceIdentifier");
  ...
  }
  {
    ...
    scope_spec->set_ref("onevnShields.Scope");
...
void OneVNShieldsContentSetting::HandleFunction(const std::string& method_name,
  ...
  std::string full_name = "onevnShields.ContentSetting." + method_name;
  ...
  request_handler_->StartRequest(
      context, "onevnShields." + method_name, std::move(converted_arguments),
